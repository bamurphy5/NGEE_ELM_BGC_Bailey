...
domain=/home/bails/NGEE_ELM/BEO_domain_multicell.nc
surf=/home/bails/NGEE_ELM/BEO_surfdata_multicell_arcticpfts_hydro.nc
paramfile=/home/bails/NGEE_ELM/clm_params_arctic_updated.nc
...
--cpl_bypass --machine cades-baseline --no_dynroot --gswp3 --daymet4 --nofire --nopftdyn --nopointdata \
--model_root /home/bails/ELM-alquimia/E3SM --ccsm_input /gpfs/wolf2/cades/cli185/proj-shared/pt-e3sm-inputdata \
--domainfile $domain \
...
--alquimia /home/bails/ELM-alquimia/REDOX-PFLOTRAN/ELM_decks/CTC_alquimia_forELM_O2consuming.in \
--alquimia_ad /home/bails/ELM-alquimia/REDOX-PFLOTRAN/ELM_decks/CTC_alquimia_forELM_O2consuming_adspinup.in \
--marsh --tide_forcing_file /nfs/data/ccsi/proj-shared/b0u/NGEE_ELM/BEO_hydro_BC_multicell.nc \
--parm_file /home/bails/NGEE_ELM/parms_BEO.txt
